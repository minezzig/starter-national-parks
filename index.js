const submitHandler = (event) => {
  ...
  const formData = new FormData(form); //! new form data!!!
  // const name = formData.get("name"); //!get's a particular field from form
...
function validateExists(value) {
  return value && value.trim(); // checks to make sure that something was entered and it's not just a space
}
